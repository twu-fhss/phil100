...
This unit is divided into two lectures. The first lecture is about wisdom and action and the second lecture is about wisdom and knowledge.
...
Pre-reading: Robert Nozick, ``What Is Wisdom And Why Do Philosophers Love It So?''
...
Pre-reading: (Preface to Principles of Philosophy; Principles 1, 2, 3, 75)
...
\subsection*{Required Note Taking Learning Activity}\label{required-note-taking-learning-activity}}
\addcontentsline{toc}{subsection}{Required Note Taking Learning Activity}
...
Pre-reading: \url{http://classics.mit.edu/Plato/apology.html}
...
\subsection*{Required Note Taking Learning Activity}\label{required-note-taking-learning-activity-1}}
\addcontentsline{toc}{subsection}{Required Note Taking Learning Activity}
...
\subsection*{Required Note Taking Learning Activity}\label{required-note-taking-learning-activity-2}}
\addcontentsline{toc}{subsection}{Required Note Taking Learning Activity}
