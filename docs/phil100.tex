...
\tightlist
\item
  Plato's Apology - \url{https://classics.mit.edu/Plato/apology.html}
\end{itemize}
...
\tightlist
\item
  \href{assets/u1/PHIL-100-Aristotle-NE-VIII-IX-X.pdf}{Aristotle, \emph{Nicomachean Ethics}, Books VIII, IX and X}
\end{itemize}
...
\tightlist
\item
  \href{assets/u1/PHIL-100-Heinrichs-Thank-You-for-Arguing.pdf}{Heinrichs, Thank You for Arguing}
\end{itemize}
