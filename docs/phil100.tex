...
\hypersetup{
  ...
  pdfauthor={Andrew Bigham},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Philosophy for Life}
\author{Andrew Bigham}
\date{2023-02-01}
...
! :fa-bell:\emph{Note:} \textbf{WC} = For students required to attend the Writing Centre.
...
\begin{figure}
 \includegraphics[width=4.56in]{assets/course-intro/menu} \caption{Top menu bar}\label{fig:unnamed-chunk-9}
 \end{figure}

The faint left and right arrows at the sides of each page (or bottom of the page if it's narrow enough) allow you to step to the next/previous section. Here's what they look like:

\begin{figure}
 \includegraphics[width=0.93in]{assets/course-intro/left_arrow} \includegraphics[width=0.74in]{assets/course-intro/right_arrow} \caption{Left and right navigation arrows}\label{fig:unnamed-chunk-10}
 \end{figure}
